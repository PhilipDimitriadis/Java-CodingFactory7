...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Product> products = new ArrayList<>(List.of(new Product("Apples", 12.5, 17),               // Mutable List
                new Product("Oranges", 12, 9), new Product("Berries", 12.5, 10), new Product("Apples", 32.5, 17)));
